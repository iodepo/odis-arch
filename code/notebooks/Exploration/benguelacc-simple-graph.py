...
Usage:   python benguelacc-simple-graph.py
...
PATH_TO_DATA_FOLDER = "./data-benguelacc/" #directory must exist
TEMPLATE_GRAPH_FILENAME = "benguelacc-simple-graph-template.json"
NEW_GRAPH_FILENAME = "benguelacc-simple-graph.json"
LOGFILE = "benguelacc-simple-graph.log"
