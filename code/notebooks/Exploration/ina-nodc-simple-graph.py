...
Usage:   python ina-nodc-simple-graph.py
...
TEMPLATE_GRAPH_FILENAME = "ina-nodc-simple-graph-template.json"
NEW_GRAPH_FILENAME = "ina-nodc-simple-graph.json"
LOGFILE = "ina-nodc-simple-graph.log"
