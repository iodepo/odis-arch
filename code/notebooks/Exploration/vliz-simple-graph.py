...
Usage:   python vliz-simple-graph.py
...
Notes:
         ...
         to check format, with the command:
             ...
             jsonld format vliz-simple-graph.json > ttt.json
    
"""

# define common variables
PATH_TO_DATA_FOLDER = "./data-vliz/" #directory must exist
TEMPLATE_GRAPH_FILENAME = "vliz-simple-graph-template.json"
NEW_GRAPH_FILENAME = "vliz-simple-graph.json"
LOGFILE = "vliz-simple-graph.log"
