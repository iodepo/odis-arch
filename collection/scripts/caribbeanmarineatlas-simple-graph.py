...
Usage:   python caribbeanmarineatlas-simple-graph.py
...
Notes:
         ...
         to check format, with the command:
             ...
             jsonld format caribbeanmarineatlas-simple-graph.json > ttt.json
    
"""

# define common variables
PATH_TO_DATA_FOLDER = "./data-caribbeanmarineatlas/" #directory must exist
TEMPLATE_GRAPH_FILENAME = "caribbeanmarineatlas-simple-graph-template.json"
NEW_GRAPH_FILENAME = "caribbeanmarineatlas-simple-graph.json"
LOGFILE = "caribbeanmarineatlas-simple-graph.log"
