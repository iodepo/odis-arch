...
Usage:   python emodnet-simple-graph.py
...
Notes:
         ...
         to check format, with the command:
             ...
             jsonld format emodnet-simple-graph.json > ttt.json
    
"""

# define common variables
PATH_TO_DATA_FOLDER = "./data-emodnet/" #directory must exist
TEMPLATE_GRAPH_FILENAME = "emodnet-simple-graph-template.json"
NEW_GRAPH_FILENAME = "emodnet-simple-graph.json"
LOGFILE = "emodnet-simple-graph.log"
SHORTNAME = "emodnet" #must be hyphen
