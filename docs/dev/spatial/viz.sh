...
jsonld format -q $1 | \
    rapper -i nquads -o dot -I https://science-on-schema.org/ - | \
    ...
    dot  -Estyle=dotted -Gsplines=true -Grankdir=TP  -Tsvg -o out.svg
    #neato -Goverlap=false -Estyle=dotted -Gsplines=true    -Grankdir=TP -Tsvg -o out.svg
