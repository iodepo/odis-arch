...
def wis2_mode(source):
    print(f"WIS2 mode: Processing data from lancedb table {source} to a file")
    ...
    table = db[table_name]
    output_jsonl = f"./stores/wis2/{table_name}.jsonl"
...
def main():
    wis2_mode("sparql_results_grouped_augmented")
